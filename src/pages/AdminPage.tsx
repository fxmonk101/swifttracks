...
const AdminPage = () => {
  ...
  const fetchShipments = async () => {
    const { data, error } = await supabase
      .from("shipments")
      .select(
        "id, tracking_id, service_type, status, sender_name, sender_city, sender_state, sender_country, receiver_name, receiver_city, receiver_state, receiver_country, weight, estimated_delivery_date, assigned_driver, created_at, current_lat, current_lng"
      )
