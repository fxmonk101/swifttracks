    ...
    <section className="container py-16">
      <div className="max-w-3xl mx-auto">
        {[
          ...
          { title: "5. Claims and Disputes", content: "Claims for lost or damaged packages must be filed within 30 days of the expected delivery date. Claims can be submitted via our support team at +1 (213) 595-7723 (call or text) or support@transporthaven.com." },
